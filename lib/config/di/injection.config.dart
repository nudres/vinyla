...
import '../../data/datasource/firebase/firebase_realtime_datasource.dart'
    as _i9;
import '../../data/datasource/firebase/firebase_realtime_datasource.dart' as _i9;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i3.AuthRepository>(() => _i4.AuthRepositoryImpl(get<_i5.FirebaseAuthDatasource>()));
  ...
  gh.singleton<_i7.FirebaseAuthDatasource>(_i7.FirebaseAuthDatasource(get<_i6.FirebaseAuth>()));
