...
import '../../data/datasource/config/profile_initializer.dart' as _i15;
...
import '../../domain/usecase/auth/login_credential/login_credential_impl.dart'
    as _i22;
import '../../domain/usecase/auth/login_phone/login_phone_impl.dart' as _i23;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i10.Mapper<_i12.ProfileDTO, _i10.ProfileModel>>(
      () => _i14.ProfileMapper());
  gh.factory<_i15.ProfileInitializer>(() => _i15.ProfileInitializer());
  gh.factory<_i10.ProfileRepository>(() => _i16.ProfileRepositoryImpl(
        get<_i5.FirebaseDatabaseDatasource>(),
        get<_i15.ProfileInitializer>(),
      ));
  gh.factory<_i10.VerifyPhoneUseCase>(() => _i17.VerifyPhoneUseCaseImpl(
        get<_i10.AuthRepository>(),
        get<_i10.Mapper<_i12.UserDTO, _i10.UserModel>>(),
        get<_i12.FirebaseExceptionKeys>(),
      ));
  gh.singleton<_i18.FirebaseAuthDatasource>(_i18.FirebaseAuthDatasource(
    get<_i6.FirebaseAuth>(),
    get<_i9.HttpConfig>(),
  ));
  gh.singleton<_i19.FirebaseDatabaseDatasource>(
      _i19.FirebaseDatabaseDatasource(get<_i8.FirebaseFirestore>()));
  gh.factory<_i10.GetAuthorizedUserUseCase>(
      () => _i20.GetAuthorizedUserUseCaseImpl(
            get<_i10.AuthRepository>(),
            get<_i10.Mapper<_i12.UserDTO, _i10.UserModel>>(),
          ));
  gh.factory<_i10.GetProfileUseCase>(() => _i21.GetProfileUseCaseImpl(
  ...
  gh.factory<_i10.LoginCredentialUseCase>(() => _i22.LoginCredentialUseCaseImpl(
        get<_i10.AuthRepository>(),
        get<_i10.Mapper<_i12.UserDTO, _i10.UserModel>>(),
      ));
  gh.factory<_i10.LoginPhoneUseCase>(() => _i23.LoginPhoneUseCaseImpl(
        get<_i10.AuthRepository>(),
        get<_i10.Mapper<_i12.UserDTO, _i10.UserModel>>(),
        get<_i12.FirebaseExceptionKeys>(),
      ));
